...
// 21.2.5.3 get RegExp.prototype.flags()
if(__webpack_require__(19) && /./g.flags != 'g')__webpack_require__(14).f(RegExp.prototype, 'flags', {
  configurable: true,
...
$export($export.P + $export.F * (__webpack_require__(99) != Object || !__webpack_require__(32)(arrayJoin)), 'Array', {
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(30)(proto, TO_PRIMITIVE, __webpack_require__(504));
...
$export($export.S + $export.F * !__webpack_require__(19), 'Object', {defineProperties: __webpack_require__(352)});
...
// Polyfills
"use strict";
__webpack_require__(402); // Internet Explorer 9 support
// import 'core-js/es6';
